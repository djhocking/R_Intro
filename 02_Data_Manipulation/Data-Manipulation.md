...
library(RCurl)
url <- foo <- getURL("https://raw.github.com/djhocking/R_Intro/master/02_Data_Manipulation/Salamander_Demographics.csv", 
    ssl.verifypeer = FALSE)  ## ssl.verifypeer is to subverte an SSL error you get otherwise
